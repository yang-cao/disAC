...
value propagation across the attributes for them; this is
similar to how DBMS evaluates complex \SQL queries via \SQL
blocks (\SPC sub-queries).}
...
$Q$ being scan-free over $\kb{\R}$. Lemma~\ref{lem-ILP}(3) is a
sufficient and necessary characterization for $Q$ being strongly
scan-free over the selected $\kb{\R}$.}
