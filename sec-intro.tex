...
this practice is that \kv stores are often a natural
...
\warn{While this works well with point accesses, the model
however causes large scan overhead due to excessive \get
invocations, which makes it sub-optimal for analytical
workloads, \eg SQL.}
...
\vspace{0.6ex}
\warn{To alleviate the scan overhead for analytical \SQL processing over
