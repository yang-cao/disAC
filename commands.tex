...
\newcommand*\tpcds{{\small \at{TPC}-\at{DS}}\xspace}
\newcommand*\tpch{{\small \at{TPC}-\at{H}}\xspace}
\newcommand*\imdb{{\small \at{IMDB}}\xspace}
% \newcommand*\G{\mathcal{G}}
...
\newcommand*\bs{{\small \at{BRS}}\xspace}
\newcommand*\bss{{$\text{\small \at{BRS}}s$}\xspace}
\newcommand*\bds{\text{\small \at{BDS}}\xspace}
\newcommand*\bdss{{$\text{\small \at{BDS}}s$}\xspace}
\newcommand*\opts{\text{\small \at{OPTS}}\xspace}
\newcommand*\usc{\text{\small \at{USC}}\xspace}
\newcommand*\qcssel{\text{\small \at{QCSS}}\xspace}
\newcommand*\uscsel{\text{\small \at{USCS}}\xspace}

\newcommand*\soc{{\small \at{SoC}}\xspace}
